...
#define MAX_LL_DATA_SZ	27 //LL Payload Lenght HW Fifo
#define MAX_ATT_DATA_SZ	128//MTU user buff 125
#define BD_ADDR_SZ 			6
...
#pragma pack()
	...
	extern uint8_t GATTDataSend(uint8_t type, struct gap_att_report* p_report, uint16_t len, uint8_t *p_data);
