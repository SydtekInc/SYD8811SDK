...
#define BLE_KEYBOARD_OUTPUT_REPORT_VALUE_HANDLE 0x0046
#define BLE_REPORT_MAP_UUID 0x2A4B
#define BLE_REPORT_MAP_VALUE_HANDLE 0x0049
#define BLE_BOOT_KEYBOARD_INPUT_REPORT_UUID 0x2A22
#define BLE_BOOT_KEYBOARD_INPUT_REPORT_VALUE_HANDLE 0x004C
#define BLE_BOOT_KEYBOARD_OUTPUT_REPORT_UUID 0x2A32
#define BLE_BOOT_KEYBOARD_OUTPUT_REPORT_VALUE_HANDLE 0x004F
#define BLE_BOOT_MOUSE_INPUT_REPORT_UUID 0x2A33
#define BLE_BOOT_MOUSE_INPUT_REPORT_VALUE_HANDLE 0x0051
#define BLE_HID_INFORMATION_UUID 0x2A4A
#define BLE_HID_INFORMATION_VALUE_HANDLE 0x0054
#define BLE_HID_CONTROL_POINT_UUID 0x2A4C
#define BLE_HID_CONTROL_POINT_VALUE_HANDLE 0x0056
...
static const uint8_t  _gatt_database_report_handle[] =
{
   ...
   0x12, 0x18, 0x22, 0x2A, 0x4C, 0x00, 0x4D, 0x00, 
   0x12, 0x18, 0x33, 0x2A, 0x51, 0x00, 0x52, 0x00, 
};
...
static const uint8_t _gatt_database_characteristic[] =
{
   ...
   0x0A, 0x45, 0x00, 0x03, 0x28, 0x0E, 0x46, 0x00, 0x4D, 0x2A, //     0x0045  <Characteristic(0x2803)>  <Properties:0x0E>  <Value Handle:0x0046>  <UUID:KEYBOARD_OUTPUT_REPORT(0x2A4D)>
   0x0A, 0x48, 0x00, 0x03, 0x28, 0x02, 0x49, 0x00, 0x4B, 0x2A, //     0x0048  <Characteristic(0x2803)>  <Properties:0x02>  <Value Handle:0x0049>  <UUID:REPORT_MAP(0x2A4B)>
   0x0A, 0x4B, 0x00, 0x03, 0x28, 0x12, 0x4C, 0x00, 0x22, 0x2A, //     0x004B  <Characteristic(0x2803)>  <Properties:0x12>  <Value Handle:0x004C>  <UUID:BOOT_KEYBOARD_INPUT_REPORT(0x2A22)>
   0x0A, 0x4E, 0x00, 0x03, 0x28, 0x0E, 0x4F, 0x00, 0x32, 0x2A, //     0x004E  <Characteristic(0x2803)>  <Properties:0x0E>  <Value Handle:0x004F>  <UUID:BOOT_KEYBOARD_OUTPUT_REPORT(0x2A32)>
   0x0A, 0x50, 0x00, 0x03, 0x28, 0x12, 0x51, 0x00, 0x33, 0x2A, //     0x0050  <Characteristic(0x2803)>  <Properties:0x12>  <Value Handle:0x0051>  <UUID:BOOT_MOUSE_INPUT_REPORT(0x2A33)>
   0x0A, 0x53, 0x00, 0x03, 0x28, 0x02, 0x54, 0x00, 0x4A, 0x2A, //     0x0053  <Characteristic(0x2803)>  <Properties:0x02>  <Value Handle:0x0054>  <UUID:HID_INFORMATION(0x2A4A)>
   0x0A, 0x55, 0x00, 0x03, 0x28, 0x04, 0x56, 0x00, 0x4C, 0x2A, //     0x0055  <Characteristic(0x2803)>  <Properties:0x04>  <Value Handle:0x0056>  <UUID:HID_CONTROL_POINT(0x2A4C)>
...
static const uint8_t _gatt_database_value[] =
{
   ...
   0x08, 0x00, 0x46, 0x00, 0x70, 0x4D, 0x2A, 0x00, //     0x0046    <UUID:KEYBOARD_OUTPUT_REPORT(0x2A4D)>  <Value:Report Value(0x00)>
   0x09, 0x00, 0x47, 0x00, 0x10, 0x08, 0x29, 0x01, 0x02, //     0x0047    <UUID:REPORT_REFERENCE(0x2908)>  <Value:(Report ID(0x01), Report Type(0x02))>
   , //     0x0049    <UUID:REPORT_MAP(0x2A4B)>  <Value:Report Map Value()>
   0x07, 0x00, 0x4A, 0x00, 0x10, 0x07, 0x29, //     0x004A    <UUID:EXTERNAL_REPORT_REFERENCE(0x2907)>  <Value:(External Report Reference())>
   0x08, 0x00, 0x4C, 0x00, 0x10, 0x22, 0x2A, 0x00, //     0x004C    <UUID:BOOT_KEYBOARD_INPUT_REPORT(0x2A22)>  <Value:Boot Keyboard Input Report Value(0x00)>
   0x07, 0x00, 0x4D, 0x00, 0x10, 0x02, 0x29, //     0x004D    <UUID:GATT.CLIENT_CHARACTERISTIC_CONFIGURATION(0x2902)>  <Value:(Properties())>
   0x08, 0x00, 0x4F, 0x00, 0x10, 0x32, 0x2A, 0x00, //     0x004F    <UUID:BOOT_KEYBOARD_OUTPUT_REPORT(0x2A32)>  <Value:Boot Keyboard Output Report Value(0x00)>
   0x0B, 0x00, 0x51, 0x00, 0x10, 0x33, 0x2A, 0x00, 0x00, 0x00, 0x00, //     0x0051    <UUID:BOOT_MOUSE_INPUT_REPORT(0x2A33)>  <Value:Boot Mouse Input Report Value(0x00, 0x00, 0x00, 0x00)>
   0x07, 0x00, 0x52, 0x00, 0x10, 0x02, 0x29, //     0x0052    <UUID:GATT.CLIENT_CHARACTERISTIC_CONFIGURATION(0x2902)>  <Value:(Properties())>
   0x0B, 0x00, 0x54, 0x00, 0x10, 0x4A, 0x2A, 0x11, 0x01, 0x00, 0x03, //     0x0054    <UUID:HID_INFORMATION(0x2A4A)>  <Value:bcdHID(0x0111), bCountryCode(0x00), Flags(0x03)>
   0x08, 0x00, 0x56, 0x00, 0x10, 0x4C, 0x2A, 0x00, //     0x0056    <UUID:HID_CONTROL_POINT(0x2A4C)>  <Value:HID Control Point Command(0x00)>
