...
#define BLE_BOOT_KEYBOARD_INPUT_REPORT_VALUE_HANDLE 0x004B
#define BLE_BOOT_KEYBOARD_OUTPUT_REPORT_UUID 0x2A32
#define BLE_BOOT_KEYBOARD_OUTPUT_REPORT_VALUE_HANDLE 0x004E
#define BLE_BOOT_MOUSE_INPUT_REPORT_UUID 0x2A33
#define BLE_BOOT_MOUSE_INPUT_REPORT_VALUE_HANDLE 0x0050
#define BLE_HID_INFORMATION_UUID 0x2A4A
#define BLE_HID_INFORMATION_VALUE_HANDLE 0x0053
#define BLE_HID_CONTROL_POINT_UUID 0x2A4C
#define BLE_HID_CONTROL_POINT_VALUE_HANDLE 0x0055
...
static const uint8_t  _gatt_database_report_handle[] =
{
   ...
   0x12, 0x18, 0x22, 0x2A, 0x4B, 0x00, 0x4C, 0x00, 
   0x12, 0x18, 0x33, 0x2A, 0x50, 0x00, 0x51, 0x00, 
};
...
static const uint8_t _gatt_database_characteristic[] =
{
   ...
   0x0A, 0x4A, 0x00, 0x03, 0x28, 0x12, 0x4B, 0x00, 0x22, 0x2A, //     0x004A  <Characteristic(0x2803)>  <Properties:0x12>  <Value Handle:0x004B>  <UUID:BOOT_KEYBOARD_INPUT_REPORT(0x2A22)>
   0x0A, 0x4D, 0x00, 0x03, 0x28, 0x0E, 0x4E, 0x00, 0x32, 0x2A, //     0x004D  <Characteristic(0x2803)>  <Properties:0x0E>  <Value Handle:0x004E>  <UUID:BOOT_KEYBOARD_OUTPUT_REPORT(0x2A32)>
   0x0A, 0x4F, 0x00, 0x03, 0x28, 0x12, 0x50, 0x00, 0x33, 0x2A, //     0x004F  <Characteristic(0x2803)>  <Properties:0x12>  <Value Handle:0x0050>  <UUID:BOOT_MOUSE_INPUT_REPORT(0x2A33)>
   0x0A, 0x52, 0x00, 0x03, 0x28, 0x02, 0x53, 0x00, 0x4A, 0x2A, //     0x0052  <Characteristic(0x2803)>  <Properties:0x02>  <Value Handle:0x0053>  <UUID:HID_INFORMATION(0x2A4A)>
   0x0A, 0x54, 0x00, 0x03, 0x28, 0x04, 0x55, 0x00, 0x4C, 0x2A, //     0x0054  <Characteristic(0x2803)>  <Properties:0x04>  <Value Handle:0x0055>  <UUID:HID_CONTROL_POINT(0x2A4C)>
...
static const uint8_t _gatt_database_value[] =
{
   ...
   0x08, 0x00, 0x4B, 0x00, 0x10, 0x22, 0x2A, 0x00, //     0x004B    <UUID:BOOT_KEYBOARD_INPUT_REPORT(0x2A22)>  <Value:Boot Keyboard Input Report Value(0x00)>
   0x07, 0x00, 0x4C, 0x00, 0x10, 0x02, 0x29, //     0x004C    <UUID:GATT.CLIENT_CHARACTERISTIC_CONFIGURATION(0x2902)>  <Value:(Properties())>
   0x08, 0x00, 0x4E, 0x00, 0x10, 0x32, 0x2A, 0x00, //     0x004E    <UUID:BOOT_KEYBOARD_OUTPUT_REPORT(0x2A32)>  <Value:Boot Keyboard Output Report Value(0x00)>
   0x0B, 0x00, 0x50, 0x00, 0x10, 0x33, 0x2A, 0x00, 0x00, 0x00, 0x00, //     0x0050    <UUID:BOOT_MOUSE_INPUT_REPORT(0x2A33)>  <Value:Boot Mouse Input Report Value(0x00, 0x00, 0x00, 0x00)>
   0x07, 0x00, 0x51, 0x00, 0x10, 0x02, 0x29, //     0x0051    <UUID:GATT.CLIENT_CHARACTERISTIC_CONFIGURATION(0x2902)>  <Value:(Properties())>
   0x0B, 0x00, 0x53, 0x00, 0x10, 0x4A, 0x2A, 0x11, 0x01, 0x00, 0x03, //     0x0053    <UUID:HID_INFORMATION(0x2A4A)>  <Value:bcdHID(0x0111), bCountryCode(0x00), Flags(0x03)>
   0x08, 0x00, 0x55, 0x00, 0x10, 0x4C, 0x2A, 0x00, //     0x0055    <UUID:HID_CONTROL_POINT(0x2A4C)>  <Value:HID Control Point Command(0x00)>
